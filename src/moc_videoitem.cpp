...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_VideoItem_t, stringdata) + ofs \
...
const QMetaObject VideoItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_VideoItem.data,
      qt_meta_data_VideoItem,  qt_static_metacall, 0, 0}
};
