/****************************************************************************
** Meta object code from reading C++ file 'plotitem.h'
**
...
#error "The header file 'plotitem.h' doesn't include <QObject>."
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_PlotItem_t, stringdata) + ofs \
...
const QMetaObject PlotItem::staticMetaObject = {
    { &QCustomPlot::staticMetaObject, qt_meta_stringdata_PlotItem.data,
      qt_meta_data_PlotItem,  qt_static_metacall, 0, 0}
};
